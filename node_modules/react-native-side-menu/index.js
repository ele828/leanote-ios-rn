...
var SideMenu = React.createClass({
  ...
  getContentView: function() {
    ...
    // for(var k in this.props.children.props.children) {
    //   console.log(k)
    // }
    if(this.left > 60) {
      return (
          <View
            accessible={false}
            onStartShouldSetResponder={()=>{this.closeMenu()}}
            style={[styles.frontView, {opacity: 0.7}]}
  ...
  getMenuView: function() {
    ...
    return (
      <View style={styles.menu}>
        {React.addons.cloneWithProps(this.props.menu, { menuActions: menuActions, nav: this.props.nav, router: this.props.children.props.children.props })}
      </View>
    );
  },
